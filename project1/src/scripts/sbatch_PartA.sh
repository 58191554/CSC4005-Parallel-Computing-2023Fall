...
#   srun -n $num_processes --cpus-per-task 1 --mpi=pmi2 ${CURRENT_DIR}/../../build/src/cpu/mpi_PartA ${CURRENT_DIR}/../../images/20K-RGB.jpg ${CURRENT_DIR}/../../images/20K-Gray-MPI-${num_processes}.jpg
#   echo ""
# done
...
do
  ...
  srun -n 1 --cpus-per-task $num_cores ${CURRENT_DIR}/../../build/src/cpu/pthread_PartA ${CURRENT_DIR}/../../images/20K-RGB.jpg ${CURRENT_DIR}/../../images/grey-pthread/20K-Gray-${num_cores}.jpg ${num_cores} 
  echo ""
done
...
# do
#   echo "Number of cores: $num_cores"
#   srun -n 1 --cpus-per-task $num_cores ${CURRENT_DIR}/../../build/src/cpu/openmp_PartA ${CURRENT_DIR}/../../images/20K-RGB.jpg ${CURRENT_DIR}/../../images/grey-OpenMP/20K-Gray-${num_cores}.jpg
#   echo ""
# done
